...
import com.feedhenry.securenativeandroidtemplate.authenticate.SimpleAuthenticationProvider;
 ...
 */
public class SimpleAuthenticationFragment extends Fragment {

    View view;

    private SimpleAuthenticationProvider mAuthProvider = new SimpleAuthenticationProviderImpl() {
        @Override
    ...
    public SimpleAuthenticationFragment() {
     ...
     * @param authProvider
     */
    public void setAuthProvider(SimpleAuthenticationProvider authProvider) {
