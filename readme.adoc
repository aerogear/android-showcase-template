...
If you are using HTTPS, update the certificate pinning configuration in link:app/src/main/res/xml/network_security_config[network_security_config.xml] file
